...
- Checked missing Region, Country, and Category values.
- Used helper columns to handle missing categorical values.
- Used AVERAGEIFS to fill missing numerical values where applicable.
...
- Analyzed revenue performance by region.
- Calculated order count by region.
...
- Electronics was identified as a top-performing category.
- North and West showed consistent profitability.
